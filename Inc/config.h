...
#define BAT_CALIB_REAL_VOLTAGE        41.11       // input voltage measured by multimeter
#define BAT_CALIB_ADC                 1406       // adc-value measured by mainboard (value nr 5 on UART debug output)
...
#define DEBUG_SERIAL         // right sensor board cable, disable if I2C (nunchuck or lcd) is used!
...
#define CONTROL_MOTOR_TEST_RPM 120
#define CONTROL_MOTOR_TEST_PADDING 3
